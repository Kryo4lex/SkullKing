...
namespace SkullKingCore.Core.Game.Interfaces
{
    public interface IGameController
    {
        ...
        Task AnnounceBidAsync(GameState gameState, TimeSpan maxWait);
        ...
        Task NotifyCardPlayedAsync(GameState gameState, Player player, Card playedCard);
        Task NotifyAboutSubRoundWinnerAsync(GameState gameState, Player? winner, Card? winningCard);
        ...
        Task NotifyAboutMainRoundEndAsync(GameState gameState);
