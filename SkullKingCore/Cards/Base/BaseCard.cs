...
namespace SkullKingCore.Cards.Base
{
    public abstract class BaseCard : ICard
    {
        ...
        public static bool IsNumberCard(BaseCard card)
        {
        ...
        public static void PrintListFancy(List<BaseCard> cards, string headerIndex = "Index", string headerCardType = "Card Type", string headerSubType = "Sub Type")
        {
